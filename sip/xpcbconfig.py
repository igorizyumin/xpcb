...
_pkg_config = {
    ...
    'xpcb_sip_flags':  '-x VendorID -t WS_X11 -x PyQt_NoPrintRangeBug -t Qt_4_7_2 -x Py_v3 -g'
}
...
class XpcbModuleMakefile(pyqtconfig.QtGuiModuleMakefile):

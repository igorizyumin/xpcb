...
installs.append(["xpcbmain.sip", os.path.join(config.default_sip_dir, "xpcb")])
...
content = {
    ...
    # installed.
    "xpcb_sip_dir":    config.default_sip_dir,

    # Publish the set of SIP flags needed by this module.  As these are the
    # same flags needed by the qt module we could leave it out, but this
    # allows us to change the flags at a later date without breaking
    # scripts that import the configuration module.
    "xpcb_sip_flags":  pyqt_sip_flags
}

# This creates the helloconfig.py module from the helloconfig.py.in
# template and the dictionary.
sipconfig.create_config_module("xpcbconfig.py", "xpcbconfig.py.in", content)

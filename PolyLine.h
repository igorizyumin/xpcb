...
public:
	...
	CPolyPt GetPt(int ic) {return corner.at(ic);}
...
//	QList <dl_element*> dl_side;	// graphic elements
//	QList <dl_element*> dl_side_sel;
//	QList <dl_element*> dl_corner_sel;
	int m_hatch;	// hatch style, see enum above
	int m_nhatch;	// number of hatch lines
//	QList <dl_element*>  dl_hatch;	// hatch lines
